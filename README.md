...
The following procedure addresses fairness by identifying and mitigating spurious corelation between the attributes via an adversarial training paradigm
...
- Based on some analysis of the data population and the above results, found "Male" as the spurious attribute and "Bald" as the target (affecting) attribute.
